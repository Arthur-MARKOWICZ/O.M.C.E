...
@Service
public class CadastroResistor extends CadastroProdutoTemplate {

    public CadastroResistor(
    ...
    protected void configurarCategoria(
        ...
        produto.setCategoria(Categoria.REGISTORES);
        produto.setVoltagem(dados.voltagem());
    }
}