...
export type Session = { token: string; id: number | string; nome: string };
export type Product = {
...
export type User = { id: number; nome: string; nomeUser: string; email: string; telefone: string; cpf: string; dataNasc: string; sexo?: string; endereco?: Address };
